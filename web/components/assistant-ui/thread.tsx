...
const STARTER_PROMPTS: { title: string; prompt: string }[] = [
  {
    title: "Foreign flow on 2330",
    prompt: "Show the institutional chip flow for 2330 over the last 30 trading days.",
  },
  {
    title: "Accumulation screen this week",
    prompt:
      "Run an accumulation screen: foreign net buying for at least 5 consecutive days, top 20 tickers.",
  },
  {
    title: "TSMC supply chain",
    prompt: "Map the Taiwan AI supply chain. Group companies by pillar and node.",
  },
  {
    title: "Quant indicators for 6488",
    prompt: "Pull quant indicators for 6488 and tell me what stands out.",
  },
  {
    title: "Latest news on 2454",
    prompt: "Summarize recent news mentioning 2454 from the last 7 days.",
  },
  {
    title: "Current market regime",
    prompt: "What is the current market regime? Use a 30-day window.",
  },
];
