...
## Decisions
- [2026-09-01 — Global macro coverage](decisions/2026-09-01-global-macro-coverage.md) — Japan/Korea/China/Europe added to `raw_macro` (5 → 11 series); the Asian peers trade ALONGSIDE Taipei, so `when_known` splits genuinely-overnight data from same-session prints and the pre-market brief renders them as two separately-labelled lines
