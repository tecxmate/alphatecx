...
- 2026-05-11: Ticker-page news loading was also batched by fetching recent news once and applying the existing ticker/company title-substring match in memory with the same per-ticker cap. [antigravity-agent]
